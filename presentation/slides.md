...
| Zero-shot (G-DINO) | 연두 vs 노랑 미세 구분 신뢰성 불확실 |
...
## 10. 통합 원칙 — "조작 중에는 belief 를 건드리지 않는다"
